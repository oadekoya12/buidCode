<script type="text/javascript" language="javascript">
	...
	jQuery(function() {
		...
		jQuery('#FC_captcha_input_<?php print $uniqueFieldID; ?>').attr('autocomplete', 'off');
	});
</script>
...
<div class="FC_captcha_input_container" id="FC_captcha_input_container_<?php print $uniqueFieldID; ?>">
  <input type="text" name="FC_captcha_input" id="FC_captcha_input_<?php print $uniqueFieldID; ?>" />
