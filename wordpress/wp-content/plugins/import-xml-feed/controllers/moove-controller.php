...
class Moove_Importer_Controller {
	...
	function __construct() {
        ...
        add_action( 'moove_importer_addons_tab_content', array( &$this, 'moove_importer_load_active_tab_view' ), 5, 2 );
        add_action( 'moove_importer_check_extensions', array( &$this, 'moove_importer_check_extensions' ), 10, 1 );
        add_action( 'moove_importer_premium_section_ads', array( &$this, 'moove_importer_premium_section_ads' ) );

	}

    function moove_importer_premium_section_ads() {
        ?>
        <div class="xml-importer-locked-section">
            <span>
    ...
    function moove_importer_add_templates_tab(  $tabs, $active_tab  ) {
        ob_start();
        ?>
        <a href="?page=moove-importer&tab=plugin_templates" class="nav-tab nav-tab-disabled <?php echo $active_tab == 'plugin_templates' ? 'nav-tab-active' : ''; ?>">
