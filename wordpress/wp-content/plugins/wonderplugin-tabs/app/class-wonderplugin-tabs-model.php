...
class WonderPlugin_Tabs_Model {
	...
	function generate_body_code($id, $name, $content, $data_attributes, $has_wrapper) {
		...
		if ($item_row != null)
		{
			...
			$boolOptions = array('arrowloop', 'autoexpandpanelheight', 'fixedheaderwidth', 'fixedheaderheight', 'ajaxloading', 'ajaxloadingfirst', 'closeall', 'usetablecellfortitle', 'fixedheadersize', 'enablega', 'enabletabindex', 'keyaccess', 'fullwidthtabs', 'accordion', 'accordionmultiple', 'accordioncloseall', 'switchonmouseover', 'savestatusincookie', 'extendedheight', 'responsive', 'fullwidth', 'applydisplaynonetohiddenpanel', 'triggerresize', 'triggerresizeonload', 'disablewpautop', 'hidetitleonsmallscreen', 'donotinit', 'addinitscript', 'fullwidthtabsonsmallscreen', 'accordiononsmallscreen');
			...
			$valOptions = array('arrowfontsize', 'arrowfontcolor', 'headerwidth', 'headerheight', 'gatrackingid', 'heightmode', 'minheight', 'firstid', 'direction', 'tabposition', 'tabiconposition', 'horizontaltabalign', 'hidetitleonsmallscreenwidth', 'transition',
					'arrowstyle', 'arrowimage', 'arrowwidth', 'arrowheight', 'prevarrowcss', 'nextarrowcss', 
					'navstyle', 'navwidth', 'navheight', 'navspacing', 'navimage', 'navcss',
			...
			if (isset($items) && count($items) > 0)
			{
				...
				{		
					...
					if ($data->tabiconposition == 'top' && !$use_tablecell && $has_icon )
					{
						$ret_header .= '<br>';
					}
