  ...
  <div class="button">
      <form accept-charset="US-ASCII" action="<?php echo isset($action) ? $action : '""';?>" id="search_form" method="get">
        <input id="affiliate" name="affiliate" type="hidden" value="www.stb.gov">
    		<input autocomplete="off" class="usagov-search-autocomplete ui-autocomplete-input" id="query" name="<?php echo $s ?? 'query'; ?>" type="text" role="textbox" aria-autocomplete="list" aria-haspopup="true" value="<?php echo $_GET['s'] ?? ''; ?>" >
